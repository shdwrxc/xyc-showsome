 ...
 */
public class ObjectSizeCalculatorTwitter {
    ...
    public static long getObjectSize(Object obj) throws UnsupportedOperationException {
        return obj == null ? 0 : new ObjectSizeCalculatorTwitter(CurrentLayout.SPEC).calculateObjectSize(obj);
    }
     ...
     */
    public ObjectSizeCalculatorTwitter(MemoryLayoutSpecification memoryLayoutSpecification) {
    ...
    private static class ArrayElementsVisitor {
        ...
        public void visit(ObjectSizeCalculatorTwitter calc) {
    ...
    private class ClassSizeInfo {
        ...
        void visit(Object obj, ObjectSizeCalculatorTwitter calc) {
            calc.increaseSize(objectSize);
            enqueueReferencedObjects(obj, calc);
        }

        public void enqueueReferencedObjects(Object obj, ObjectSizeCalculatorTwitter calc) {
